...
<td style="width: 140px; text-align: center;"><a href="https://github.com/Unity-Billal-mesloub"><img width="128px" src="https://raw.githubusercontent.com/microsoft/fluentui-system-icons/78c9587b995299d5bfc007a0077773556ecb0994/assets/Cube/SVG/ic_fluent_cube_32_filled.svg" alt="devcontainers organization logo"/></a></td>
<td>
...
-   [`test`](test) - Mirroring `src`, a folder-per-template with at least a `test.sh` script. These tests are executed by the [CI](https://github.com/Unity-Billal-mesloub/templates/blob/main/.github/workflows/test-pr.yaml).
...
A starter repository [Unity-Billal-mesloub/template-starter](https://github.com/Unity-Billal-mesloub/template-starter) and [GitHub Action](https://github.com/Unity-Billal-mesloub/action-container-assets) are available to help bootstrap self-authored Templates.

We are eager to hear your feedback on self-authoring!  Please provide comments and feedback on [spec issue ](https://github.com/Unity-Billal-mesloub/Spec-Development-Containers/issues).
...
Issues related to these templates can be reported in [an issue](https://github.com/Unity-Billal-mesloub/templates/issues) in this repository.
